    ...
    private void addActionListener()
    {
        bReg.setOnClickListener((v)->
        {
            ...
            if(u!=null)
            {
                ...
                au.createUserWithEmailAndPassword(u.getEmail(), u.getPassword()).addOnCompleteListener((task) -> result.setText("Registration successful"));
                db.collection("users").document(u.getEmail()).set(Utente.userMap(u));
            }
