...
public class Flipper extends MacroA {
     ...
     */
    public Flipper(String name, String desc, String creator, String date, String password, boolean isPublic, int points, String luogo) {
        super(name, desc, creator, date, password, isPublic, 2, 20, points, luogo);
    }
}
